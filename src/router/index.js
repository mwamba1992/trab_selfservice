...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'tra/appeals',
        name: 'TraAppeals',
        component: () => import('@/views/tra/TraAppeals.vue'),
        meta: { audience: AUDIENCES.TRA },
      },
      {
        path: 'tra/appeals/:id',
        name: 'TraAppealDetail',
        component: () => import('@/views/tra/TraAppealDetail.vue'),
        meta: { audience: AUDIENCES.TRA },
      },
      {
        path: 'tra/notices',
        name: 'TraNotices',
        component: () => import('@/views/tra/TraNotices.vue'),
        meta: { audience: AUDIENCES.TRA },
      },
      {
        path: 'tra/applications',
        name: 'TraApplications',
        component: () => import('@/views/tra/TraApplications.vue'),
        meta: { audience: AUDIENCES.TRA },
      },
      {
        path: 'tra/summons',
        name: 'TraSummons',
        component: () => import('@/views/tra/TraSummons.vue'),
        meta: { audience: AUDIENCES.TRA },
      },
      {
        path: 'tra/decisions',
